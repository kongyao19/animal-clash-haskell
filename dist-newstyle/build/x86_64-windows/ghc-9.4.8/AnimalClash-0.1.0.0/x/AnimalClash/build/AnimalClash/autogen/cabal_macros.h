...
/* package AnimalClash-0.1.0.0 */
#ifndef VERSION_AnimalClash
#define VERSION_AnimalClash "0.1.0.0"
#endif /* VERSION_AnimalClash */
#ifndef MIN_VERSION_AnimalClash
#define MIN_VERSION_AnimalClash(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_AnimalClash */
...
#define CURRENT_COMPONENT_ID "AnimalClash-0.1.0.0-inplace-AnimalClash"
